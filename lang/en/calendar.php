...
$string['calendar'] = 'Training Calendar';
$string['calendarheading'] = '{$a} Training Calendar';
$string['calendarpreferences'] = 'Training Calendar preferences';
$string['calendartypes'] = 'Training Calendar types';
$string['calendarurl'] = 'Training Calendar URL: {$a}';
...
$string['colcalendar'] = 'Training Calendar';
...
$string['coursecalendar'] = '{$a} Training Calendar';
...
$string['errorbadsubscription'] = 'Training Calendar subscription not found.';
$string['errorbeforecoursestart'] = 'Cannot set event before course start date';
$string['errorcannotimport'] = 'You cannot set up a Training Calendar subscription at this time.';
...
$string['errorrequiredurlorfile'] = 'Either a URL or a file is required to import a Training Calendar.';
...
$string['eventcalendareventcreated'] = 'Training Calendar event created';
$string['eventcalendareventupdated'] = 'Training Calendar event updated';
$string['eventcalendareventdeleted'] = 'Training Calendar event deleted';
$string['eventsubscriptioncreated'] = 'Training Calendar subscription created';
$string['eventsubscriptionupdated'] = 'Training Calendar subscription updated';
$string['eventsubscriptiondeleted'] = 'Training Calendar subscription deleted';
$string['eventsubscriptioneditwarning'] = 'This Training Calendar event is part of a subscription.  Any changes you make to this event will be lost if the subscription is deleted.';
...
$string['export'] = 'Export';
 $string['exporthelp'] = 'How do I subscribe to this Training Calendar from a Training Calendar application (Google/Outlook/Other)?';
$string['exportbutton'] = 'Export';
$string['exportcalendar'] = 'Export Training Calendar';
$string['forcecalendartype'] = 'Force Training Calendar';
$string['fri'] = 'Fri';
$string['friday'] = 'Friday';
$string['fullcalendar'] = 'Full calendar';
$string['generateurlbutton'] = 'Get Training Calendar URL';
$string['gotoactivity'] = 'Go to activity';
$string['gotocalendar'] = 'Go to Training Calendar';
$string['group'] = 'Group';
...
$string['importcalendar'] = 'Import Training Calendar';
$string['importcalendarheading'] = 'Import Training Calendar...';
$string['importcalendarfrom'] = 'Import from';
$string['importfromfile'] = 'Training Calendar file (.ics)';
$string['importfromurl'] = 'Training Calendar URL';
...
$string['nocalendarsubscriptions'] = 'You have no Training Calendar subscriptions.';
$string['oneevent'] = '1 event';
$string['pollinterval'] = 'Update interval';
$string['pollinterval_help'] = 'How often you would like the Training Calendar to update with new events.';
$string['preferences'] = 'Preferences';
$string['preferences_available'] = 'Your personal preferences';
$string['preferredcalendar'] = 'Preferred Training Calendar';
...
$string['pref_startwday_help'] = 'Training Calendar weeks will be shown as starting on the day that you select here.';
...
$string['privacy:metadata:calendar:event'] = 'The Training Calendar component can store user Training Calendar event details within the core subsystem.';
$string['privacy:metadata:calendar:event:name'] = 'The name of the Training Calendar event.';
$string['privacy:metadata:calendar:event:description'] = 'The description of the Training Calendar event.';
$string['privacy:metadata:calendar:event:eventtype'] = 'The event type of the Training Calendar event.';
$string['privacy:metadata:calendar:event:timestart'] = 'The start time of the Training Calendar event.';
$string['privacy:metadata:calendar:event:timeduration'] = 'The duration of the Training Calendar event.';
$string['privacy:metadata:calendar:event_subscriptions'] = 'The Training Calendar component can stores user Training Calendar subscriptions details within the core subsystem.';
$string['privacy:metadata:calendar:event_subscriptions:name'] = 'The name of the Training Calendar subscription.';
$string['privacy:metadata:calendar:event_subscriptions:url'] = 'The url of the Training Calendar subscription.';
$string['privacy:metadata:calendar:event_subscriptions:eventtype'] = 'The event type of the Training Calendar subscription.';
$string['privacy:metadata:calendar:preferences:calendar_savedflt'] = 'The configured Training Calendar event type display user preference.';
...
$string['subscriptionname'] = 'Training Calendar name';
$string['subscriptionremoved'] = 'Training Calendar subscription {$a} removed';
$string['subscriptionsource'] = 'Event source: {$a}';
$string['subscriptionupdated'] = 'Training Calendar subscription {$a} updated';
$string['sun'] = 'Sun';
...
$string['urlforical'] = 'URL for iCalendar export, for subscribing to Training Calendar';
$string['user'] = 'User';
